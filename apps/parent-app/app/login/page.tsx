  ...
  return (
    <main className="shell">
      <div className="panel">
        <h2>Sign in</h2>
        <p className="hint">
          Guardian OTP login. Dev builds accept code <code>000000</code> for any identifier.
        </p>
        ...
        {step === "verify" && (
          <form onSubmit={onVerify}>
            ...
            <div className="form-row" style={{ flexDirection: "column" }}>
              ...
              <button type="button" onClick={() => setStep("identify")} disabled={submitting} style={{ background: "none", color: "var(--text-dim)", boxShadow: "none", border: "1px solid var(--border-strong)" }}>
                Back
              </button>
            </div>
          </form>
